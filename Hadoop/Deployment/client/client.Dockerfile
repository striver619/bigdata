...
COPY --chown=hadoop:hadoop ../../../keynote /home/hadoop/

COPY --chown=hadoop:hadoop client-entrypoint.sh /home/hadoop/
RUN chmod +x /home/hadoop/client-entrypoint.sh

ENTRYPOINT ["/home/hadoop/client-entrypoint.sh"]
